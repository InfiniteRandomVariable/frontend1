      ...
      <div className="bg-slate-700 border-t border-slate-600 overflow-x-auto scrollbar-hide">
        <div className="container mx-auto px-4">
          <div className="flex space-x-6 py-2 text-sm">
            <Link href="/category/video" className="whitespace-nowrap">
              Video
            </Link>
            <Link href="/deals" className="whitespace-nowrap">
              Deals
            </Link>
            <Link href="/basics" className="whitespace-nowrap">
              TechBay Basics
            </Link>
            <Link href="/bestsellers" className="whitespace-nowrap">
              Best Sellers
            </Link>
            <Link href="/live" className="whitespace-nowrap">
              Live Auctions
            </Link>
            <Link href="/watchlist" className="whitespace-nowrap">
              Watchlist
            </Link>
          </div>
        </div>
