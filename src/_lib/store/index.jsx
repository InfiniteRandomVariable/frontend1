...
const useAppStore = create<AppStore>()(
  persist(
    (set, get) => ({
      ...
      setSelectedArbiters: (arbiters: Arbiter[]) => set({ selectedArbiters: arbiters }),
      clearPurchaseData: () => set({ purchaseData: null, selectedArbiters: [] }),
...
export const useSelectedArbiters = () => useAppStore((state) => state.selectedArbiters)
...
export const useAddToWatchlist = () => useAppStore((state) => state.addToWatchlist)
export const useRemoveFromWatchlist = () => useAppStore((state) => state.removeFromWatchlist)
export const useClearWatchlist = () => useAppStore((state) => state.clearWatchlist)
export const useSetPurchaseData = () => useAppStore((state) => state.setPurchaseData)
export const useSetSelectedArbiters = () => useAppStore((state) => state.setSelectedArbiters)
export const useClearPurchaseData = () => useAppStore((state) => state.clearPurchaseData)
export const useSetLoading = () => useAppStore((state) => state.setLoading)
export const useSetError = () => useAppStore((state) => state.setError)
export const useSetHasHydrated = () => useAppStore((state) => state.setHasHydrated)
